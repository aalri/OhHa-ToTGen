...
public class Suljelaskuri {
    ...
    */
    ...
    /**
    * Metodi selvittaa kuinka monta kirjainta on matkaa oman sulkualueen päättymiseen syotteen alusta. 
    * Metodi aloittaa yhdellä "(" alkavalla sulkeella ja laskee jokaisen uuden vastaantulevan "(" alkavan sulkeen, ja päättää matkan laskennan vasta, kun päättyviä sulkeita 
    * on tullut vastaan tasoittava määrä.
    *
    * 
    *
